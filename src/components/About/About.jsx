  ...
  return (
    <section className={styles.container} id="about">
        ...
        <div className={styles.content}>
          <img src={getImageUrl("about/aboutImage.png")} alt="executive man" 
        ...
        <ul className={styles.aboutItems}>
            ...
            <li className={styles.aboutItem}>
                ...
                <div className={styles.aboutItemText}>
                    ...
                    <p>I'm developing ML models for classification problems & NLP using libraries like Sklearn, Numpy, Pandas, keras, Tensorflow & etc.</p>
                </div>
            </li>
        </ul>
        </div>
